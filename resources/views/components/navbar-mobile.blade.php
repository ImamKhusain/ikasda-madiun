<div id="navbar-hamburger-mobile"
    ...
    <div class="flex h-4/5 w-full flex-col overflow-y-scroll border-r border-white">
                    ...
                    <span class="flex items-center">
                        <a data-menu id="isr-mobile" href="#"
                            ...
                            <div class="flex items-center gap-2">
                                <img src="/images/navbar/isr.svg" alt="isr" class="aspect-square w-12" />
                ...
                <button type="button"
                    ...
                    <span class="flex items-center">
                        <a data-menu id="isr-mobile" href="#"
                            class="flex w-full items-center justify-between px-4 pt-4 hover:text-[#F5D05E]">
                            <div class="flex items-center gap-2">
                                <img src="/images/navbar/ilmiah.svg" alt="ilmiah" class="aspect-square w-12" />
                                <div class="flex flex-col items-start justify-center">
                ...
                <button type="button"
                    ...
                    <span class="flex items-center">
                        <a data-menu id="isr-mobile" href="#"
                            class="flex w-full items-center justify-between px-4 pt-4 hover:text-[#F5D05E]">
                            <div class="flex items-center gap-2">
                                <img src="/images/navbar/departemen.svg" alt="isr" class="aspect-square w-12" />
                                <div class="flex flex-col items-start justify-center">
            ...
            <button type="button"
                ...
                <span class="flex items-center">
                    <a data-menu id="isr-mobile" href="#"
                        class="flex w-full items-center justify-between px-4 pt-4 hover:text-[#F5D05E]">
                        <div class="flex items-center gap-2">
                            <img src="/images/navbar/rekrutmen.svg" alt="isr" class="aspect-square w-12" />
                            <div class="flex flex-col items-start justify-center">
            ...
            <button type="button"
                ...
                <span class="flex items-center">
                    <a data-menu id="isr-mobile" href="#"
                        class="flex w-full items-center justify-between px-4 pt-4 hover:text-[#F5D05E]">
                        <div class="flex items-center gap-2">
                            <img src="/images/navbar/prestasi.svg" alt="isr" class="aspect-square w-12" />
                            <div class="flex flex-col items-start justify-center">
            ...
            <button type="button"
                ...
                <span class="flex items-center">
                    <a data-menu id="kompetisi-mobile" href="#"
                        class="flex w-full items-center justify-between px-4 pt-4 hover:text-[#F5D05E]">
                        <div class="flex items-center gap-2">
                            <img src="/images/navbar/kompetisi.svg" alt="isr" class="aspect-square w-12" />
                            <div class="flex flex-col items-start justify-center">
        ...
        <a data-menu id="market" href="{{ route('merchandise.index') }}"
            ...
            <div class="flex items-center gap-2">
                <img src="/images/navbar/market.svg" alt="market" class="aspect-square w-12" />
            ...
            <button type="button"
                ...
                <span class="flex items-center">
                    <a data-menu id="download" href="#"
                        class="flex w-full items-center justify-between px-4 pt-4 hover:text-[#F5D05E]">
                        <div class="flex items-center gap-2">
                            <img src="/images/navbar/download.svg" alt="isr" class="aspect-square w-12" />
                            <div class="flex flex-col items-start justify-center">
